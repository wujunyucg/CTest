	...
	<div class="login">
		 <div class="login-main">
		 		<div class="login-top">
		 			...
		 			<span  style=" font-size:30px;">管理员</span>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
    				<a href="teacher_login.jsp" style=" font-size:20px;" >教师</a>
    				<form action="servlet/DealLoginServlet?identity=<%=admin %>" method="post">
		 			<input type="text" placeholder="管理账号" required="">
